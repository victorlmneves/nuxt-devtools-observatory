...
description: One guide for each Observatory tab.
---

Use these guides to understand what each panel captures and how to interpret it.
...
- [Payload Inspector](/feature-guides/payload-inspector)
